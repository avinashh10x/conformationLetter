  ...
  return (
    <div>
      <button
        ...
        className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 w-full flex justify-between transition duration-300"
      >
        Delete
      ...
      {showModal && (
        <div className="fixed inset-0  bg-black bg-opacity-50 flex justify-center items-center z-50 ixed inset-0 flex items-center justify-center bg-white/50 backdrop-blur-2xl">
