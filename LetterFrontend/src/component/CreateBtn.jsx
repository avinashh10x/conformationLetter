...
function CreateBtn() {
    ...
    return (
        <div>
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/50 backdrop-blur-2xl" onClick={() => setShowModal(false)}>
                    <div
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                            ...
                            <input type="text" name="collageName" value={formData.collageName} onChange={handleChange} placeholder="collage Name" required className="w-full p-3 border rounded-lg" />

                            <input type="date" name="enrollmentDate" value={formData.enrollmentDate} onChange={handleChange} required className="w-full p-3 border rounded-lg" />
