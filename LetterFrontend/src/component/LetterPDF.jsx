                ...
                <View style={styles.container}>
                    <View style={styles.header}>
                        ...
                        <View style={styles.companyInfo}>
                            <Text style={styles.textBold}>Novem Controls</Text>
                            ...
                            <Link src='http://www.novemcontrols.com'><Text>www.novemcontrols.com</Text></Link>
                        </View>
                    </View>

                    <View style={styles.section}>
                        <Text><Text style={styles.textBold}>Ref.No:</Text> {selectedLetter.ReferenceNo || "Reference Number"}</Text>
                        <Text><Text style={styles.textBold}>Dated:</Text> {new Date(selectedLetter.createdAt).toLocaleDateString('en-GB')}</Text>
                    </View>

                    <View style={styles.section}>
                        <Text>To,</Text>
                        <Text style={{ fontWeight: 'bold' }}>The Director</Text>
                    ...
                    <View style={styles.section}>
                        ...
                        <Text style={{ marginTop: 10 }}>
                            ...
                            in our {selectedLetter.trainingPeriod} industrial internship program from <Text style={styles.textBold}>
